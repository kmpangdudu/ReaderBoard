    ...
    public partial class readerboard : System.Web.UI.Page
    {
        ...
        protected void Phone()
        {
            ...
            try
            {
                ...
                Queued_Phone_ENG = Queued_Phone_ENG > 0 ? Queued_Phone_ENG : 0;
                Queued_Phone_FRE = Queued_Phone_FRE > 0 ? Queued_Phone_FRE : 0;
                Queued_G2T_ENG   = Queued_G2T_ENG   > 0 ? Queued_G2T_ENG   : 0;
                Queued_G2T_FRE   = Queued_G2T_FRE   > 0 ? Queued_G2T_FRE   : 0;
                Queued_Hlth_ENG  = Queued_Hlth_ENG  > 0 ? Queued_Hlth_ENG  : 0;
                Queued_Hlth_FRE  = Queued_Hlth_FRE  > 0 ? Queued_Hlth_FRE  : 0;
        ...
        protected void Chat()
        {
            try
            {
                ...
                Queued_Chat_ENG    = Queued_Chat_ENG    > 0 ? Queued_Chat_ENG    : 0;
                Queued_Chat_FRE    = Queued_Chat_FRE    > 0 ? Queued_Chat_FRE    : 0;
                //Queued_ChatApp_ENG = Queued_ChatApp_ENG > 0 ? Queued_ChatApp_ENG : 0;
                //Queued_ChatApp_FRE = Queued_ChatApp_FRE > 0 ? Queued_ChatApp_FRE : 0;
                ...
                lblTotalNumOfInQueue_Chat.Text = (Queued_Chat_ENG + Queued_Chat_FRE ).ToString();
